alter table portlet modify (defaultpreferences varchar2(4000));
...
ALTER TABLE STRUCTURE ADD content  NUMBER(1,0) default 1;
ALTER TABLE structure ADD fixed  NUMBER(1,0)  default 0;

ALTER TABLE relationship ADD fixed  NUMBER(1,0) default 0;

ALTER TABLE field ADD fixed  NUMBER(1,0) default 0;
ALTER TABLE field ADD read_only  NUMBER(1,0)  default 0;
...
ALTER TABLE field ADD searchable NUMBER(1,0);
...
CREATE INDEX idx_users_groups ON users_groups (userid, groupid);
ALTER TABLE groups_roles ADD CONSTRAINT groups_roles_pkey PRIMARY KEY (groupid, roleid);
-- Inserting backend menu definitions

INSERT INTO portlet (portletid, groupid, companyid, defaultpreferences, narrow, roles, active_) VALUES ('EXT_VIRTUAL_LINKS', 'SHARED_KEY', 'dotcms.org', '<portlet-preferences><preference><name>MenuItems</name><value><menu-items><!-- Non-New Menu Items--><menu-item><name>Virtual Links</name><icon>/html/skin/image/dotcms/icons/server_link.gif</icon><assoc-portlet>EXT_VIRTUAL_LINKS</assoc-portlet><params><param><name>struts_action</name><value>/ext/virtuallinks/view_virtuallinks</value></param></params></menu-item></menu-items></value></preference></portlet-preferences>', 0, 'Administrator,Power User,', 1);
INSERT INTO portlet (portletid, groupid, companyid, defaultpreferences, narrow, roles, active_) VALUES ('EXT_USERMANAGER', 'SHARED_KEY', 'dotcms.org', '<portlet-preferences><preference><name>MenuItems</name><value><menu-items><!-- New Menu Items--><menu-item position="top"><name>New</name><icon>/html/skin/image/dotcms/icons/page_new.gif</icon><assoc-portlet>EXT_USERMANAGER</assoc-portlet>	<params /><submenu><menu-item><name>User</name><icon>/html/skin/image/dotcms/icons/user_add.gif</icon><assoc-portlet>EXT_USERMANAGER</assoc-portlet><params><param><name>struts_action</name><value>/ext/usermanager/edit_usermanager</value></param><param><name>cmd</name><value>load_register_user</value></param></params></menu-item></submenu></menu-item><!-- Non-New Menu Items--><menu-item><name>Users</name> 	<icon>/html/skin/image/dotcms/icons/user.gif</icon><assoc-portlet>EXT_USERMANAGER</assoc-portlet><params><param><name>struts_action</name><value>/ext/usermanager/view_usermanagerlist</value></param></params></menu-item></menu-items></value></preference></portlet-preferences>', 0, 'Mailing Lists Administrator,User Manager Administrator,User Manager Editor,', 1);
...
</portlet-preferences>', 1, 'CMS Administrator,CMS User,', 1);
...
</portlet-preferences>', 1, 'CMS Administrator,', 1);
INSERT INTO portlet (portletid, groupid, companyid, defaultpreferences, narrow, roles, active_) VALUES ('EXT_13', 'SHARED_KEY', 'dotcms.org', '<portlet-preferences></portlet-preferences>', 1, 'CMS Administrator,', 1);
INSERT INTO portlet (portletid, groupid, companyid, defaultpreferences, narrow, roles, active_) VALUES ('EXT_BROWSER', 'SHARED_KEY', 'dotcms.org', ' ', 0, 'CMS Administrator,CMS User,', 1);
...
</portlet-preferences>', 1, 'Administrator,', 1);
...
</portlet-preferences>', 0, 'CMS Administrator,', 1);
...
</portlet-preferences>', 0, 'Mailing Lists Administrator,Mailing List Editor,User Manager Administrator,', 1);
...
</portlet-preferences>', 0, 'Campaign Manager Admin,Campaign Manager Viewer,Campaign Manager Editor,', 1);
...
</portlet-preferences>', 0, 'Campaign Manager Admin,Campaign Manager Editor,', 1);
...
</portlet-preferences>', 0, 'CMS Administrator,Report Administrator,Report Editor,Report Viewer,', 1);
...
UPDATE portlet SET defaultpreferences ='<portlet-preferences> <preference> <name>MenuItems</name> <value> <!-- New Menu Items--> <menu-items> <menu-item position="top"> <name>New</name> <icon>/html/skin/image/dotcms/icons/page_new.gif</icon> <assoc-portlet /> <params /> <submenu> <menu-item> <name>HTML Pages</name> <icon>/html/skin/image/dotcms/icons/page_add.gif</icon> <assoc-portlet>EXT_15</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/htmlpages/edit_htmlpage</value> </param> </params> </menu-item> <menu-item> <name>Files</name> <icon>/html/skin/image/dotcms/icons/page_white_add.gif</icon> <assoc-portlet>EXT_3</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/files/edit_file</value> </param> </params> </menu-item> <menu-item> <name>Menu Link</name> <icon>/html/skin/image/dotcms/icons/link_add.gif</icon> <assoc-portlet>EXT_18</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/links/edit_link</value> </param> <param> <name>cmd</name> <value>edit</value> </param> </params> </menu-item> <menu-item> <name>Container</name> <icon>/html/skin/image/dotcms/icons/package_add.gif</icon> <assoc-portlet>EXT_12</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/containers/edit_container</value> </param> </params> </menu-item> <menu-item> <name>Template</name> <icon>/html/skin/image/dotcms/icons/layout_add.gif</icon> <assoc-portlet>EXT_13</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/templates/edit_template</value> </param> </params> </menu-item> </submenu> </menu-item> <!-- Non-New Menu Items--> <menu-item> <name>Browser</name> <icon>/html/skin/image/dotcms/icons/application_side_list_world.gif</icon> ' WHERE portletid='EXT_BROWSER' AND companyid='dotcms.org';
UPDATE portlet SET defaultpreferences =defaultpreferences||'<assoc-portlet></assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/browser/view_browser</value> </param> </params> </menu-item> <menu-item> <name>HTML Pages</name> <icon>/html/skin/image/dotcms/icons/page.gif</icon> <assoc-portlet>EXT_15</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/htmlpages/view_htmlpages</value> </param> </params> </menu-item> <menu-item> <name>Files</name> <icon>/html/skin/image/dotcms/icons/page_white_stack.gif</icon> <assoc-portlet>EXT_3</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/files/view_files</value> </param> </params> </menu-item> <menu-item> <name>Containers</name> <icon>/html/skin/image/dotcms/icons/package.gif</icon> <assoc-portlet>EXT_12</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/containers/view_containers</value> </param> </params> </menu-item> <menu-item> <name>Templates</name> <icon>/html/skin/image/dotcms/icons/layout.gif</icon> <assoc-portlet>EXT_13</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/templates/view_templates</value> </param> </params> </menu-item> <menu-item> <name>Virtual Links</name> <icon>/html/skin/image/dotcms/icons/server_link.gif</icon> <assoc-portlet>EXT_VIRTUAL_LINKS</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/virtuallinks/view_virtuallinks</value> </param> </params> </menu-item> <menu-item> <name>Menu Link</name> <icon>/html/skin/image/dotcms/icons/link.gif</icon> <assoc-portlet>EXT_18</assoc-portlet> <params> <param> <name>struts_action</name> <value>/ext/links/view_links</value> </param> </params> </menu-item> </menu-items> </value> </preference> </portlet-preferences>' WHERE portletid='EXT_BROWSER' AND companyid='dotcms.org';
