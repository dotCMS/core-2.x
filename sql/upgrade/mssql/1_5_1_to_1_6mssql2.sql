...
ALTER TABLE web_form ALTER COLUMN custom_fields VARCHAR(2000);
...
</portlet-preferences>', 0, 'Administrator,Power User,', 1);
...
</portlet-preferences>', 0, 'Mailing Lists Administrator,User Manager Administrator,User Manager Editor,', 1);
...
</portlet-preferences>', 0, 'CMS Administrator,CMS User,', 1);
