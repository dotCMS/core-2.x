...
create table event (
   ...
   fax varchar(64),
   url varchar(255),
   registration varchar(1),
   include_file varchar(255),
   show_public varchar(1),
   ...
   received_adm_approval varchar(1),
   time_tbd varchar(1),
   primary key (inode)
);
...
create table web_event_registration (
   ...
   badge_printed varchar(1),
   how_did_you_hear varchar(255),
   ceo_name varchar(255),
   modified_qb varchar(1),
   reminder_email_sent varchar(1),
   post_email_sent varchar(1),
   primary key (inode)
);
...
create table web_event_location (
   ...
   text_email text,
   almost_at_capacity varchar(1),
   full_capacity varchar(1),
   default_contract_partner_price varchar(1),
   primary key (inode)
);
