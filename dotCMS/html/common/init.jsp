...
<%
	try {
		...
		com.dotmarketing.business.web.HostWebAPI hostApi = com.dotmarketing.business.web.WebAPILocator
				.getHostWebAPI();
		...
		try {
			com.dotmarketing.business.web.HostWebAPI hostApi = com.dotmarketing.business.web.WebAPILocator
					.getHostWebAPI();
			com.dotmarketing.beans.Host currentHost = hostApi.findDefaultHost(user, false);
			session.setAttribute(com.dotmarketing.util.WebKeys.CMS_SELECTED_HOST_ID, currentHost
					.getIdentifier());
		} catch (Exception ex) {
