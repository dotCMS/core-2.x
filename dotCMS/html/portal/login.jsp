...
<style>
	body{background-color:#124f9f;background-image:url(/html/images/skin/login_background.jpg);background-repeat:no-repeat;background-position:bottom right;}
...
<script type="text/javascript">
   ...
   //dojo.addOnLoad(showLogin);
	...
	function showLogin(){
	       ...
	       dojo.attr(dijit.byId('loginPasswordTextBox').textbox, "autocomplete", "true");
	       dojo.attr(dijit.byId('loginPasswordTextBox').textbox, "autocomplete", "true");
...
<div id="loginBox" dojoType="dijit.Dialog" draggable="false" style="display:none" title="<%= LanguageUtil.get(pageContext, "Login") %>">
	...
	<dl>
		...
		<dd><input name="loginTextBox"  autocomplete="true" id="loginTextBox" dojoType="dijit.form.TextBox" size="25" required="true" type="text" tabindex="1"  value="<%= login %>"></dd>
		
		<dt style="width:180px"><label for="loginPasswordTextBox"><%= LanguageUtil.get(pageContext, "password") %> : </label></dt>
		<dd><input name="loginPasswordTextBox" autocomplete="true" id="loginPasswordTextBox" dojoType="dijit.form.TextBox" size="25" required="true" type="password" value="" tabindex="2" ></dd>
