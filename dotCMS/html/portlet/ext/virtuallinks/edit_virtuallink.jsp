...
<%
	...
	if (InodeUtils.isSet(request.getParameter("htmlinode"))) {
		...
		if (InodeUtils.isSet(htmlPage.getInode())) {
			com.dotmarketing.beans.Identifier i = com.dotmarketing.factories.IdentifierFactory.getIdentifierByInode(htmlPage);
			uri = i.getURI();
...
<html:form action="/ext/virtuallinks/edit_virtuallink" styleId="fm">
	...
	<dl class="shadowBoxLine">
		...
		<dd>	
			...
			<% } else { %>
				<select  dojoType="dijit.form.FilteringSelect" id="hostId" name="hostId" autoComplete="true" value="<%=host.getIdentifier()%>">
