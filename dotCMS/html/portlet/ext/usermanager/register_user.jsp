				...
				while(userCatIt.hasNext()){
					...
					%>
				        ...
				        <td>
				      		...
				      		<% java.util.List childCats  = com.dotmarketing.factories.InodeFactory.getChildrenClass(cat, com.dotmarketing.portlets.categories.model.Category.class,"category_name"); %>
				      		<% if(childCats!=null){ %>
				      			<select  name="category" multiple style="width: 250px">
						      		...
						      		<%while(childCatIter.hasNext()){%>
						      			...
						      			<option value="<%= childCatUnk.getInode() %>" <%= (myAccountForm.isCategorySelected(String.valueOf(childCatUnk.getInode()))? "selected" : "") %>><%= childCatUnk.getCategoryName() %></option>
						      		<%}%>
				      			</select>
			      			<%}%>
