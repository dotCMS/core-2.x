...
<%
	...
	String portlet1Action = (String) portlet1.getInitParams().get("view-action");
	
	if (!UtilMethods.isSet(strutsAction) || strutsAction.equals(portlet1Action)) {
		...
		params.put("struts_action", new String[] {portlet1Action});
		...
		crumbTrailEntries.add(new CrumbTrailEntry(LanguageUtil.get(pageContext, "Add-/Edit"), null));
