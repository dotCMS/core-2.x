...
<!-- START Left Column User listing -->
	<div dojoType="dijit.layout.ContentPane" splitter="false" region="leading" style="width: 350px;margin-top:38px;overflow:auto;" class="lineRight">
			...
			<div dojoType="dojox.grid.DataGrid" jsId="usersGrid" id="usersGrid" class="tundra" style="cursor: pointer; cursor: hand" autoHeight="true" structure="usersGridLayout" query="{ id: '*' }"></div>
			<div class="clear"></div>
				...
				<!-- START Marketing Tab -->
					<div style="overflow-y:auto;" dojoType="dijit.layout.ContentPane" id="marketingInfoTab" title="<%= LanguageUtil.get(pageContext, "Marketing") %>">
						...
						<div id="marketingInfoWrapper">
							...
							<table class="listingTable" style="margin:10px;width:98%;">
								<tr><th nowrap><span class="nodeInsertIcon"></span> <%= LanguageUtil.get(pageContext, "User-Categories") %></th></tr>
								<tr><td style="font-size:100%;"><%@ include file="/html/portlet/ext/useradmin/view_users_categories_inc.jsp" %></td></tr>
							</table>
