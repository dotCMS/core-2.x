...
com.dotmarketing.beans.Identifier identifier = com.dotmarketing.factories.IdentifierFactory.getParentIdentifier(htmlpage);
...
//to get the pages template
Template htmlTemplate = HTMLPageFactory.getTemplate(htmlpage);
...
Folder folder = (Folder) InodeFactory.getInode(String.valueOf(htmlpage.getParent()),Folder.class);
...
try{
	showOnMenuNumber = FolderFactory.getAllMenuItems(folder).size() + 1;
...
Host host = APILocator.getHostAPI().findParentHost(folder, APILocator.getUserAPI().getSystemUser(), false);
...
<!-- START basic properties -->
	<div id="hostPropertiesTab" dojoType="dijit.layout.ContentPane" title="<%= LanguageUtil.get(pageContext, "Basic-Properties") %>" onShow="showEditButtonsRow()">
		<dl>
			...
			<dd><img src="/html/images/shim.gif" id="templateImage" height="250" width="250" border="0" style="border:1px solid #B6CBEB;"></dd>
		</dl>
	</div>
<!-- /Basic Properties -->
