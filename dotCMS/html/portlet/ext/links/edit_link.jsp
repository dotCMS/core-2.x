...
<% 
	...
	if(request.getAttribute("inode") != null){
		link = (Link) (com.dotmarketing.portlets.links.model.Link) com.dotmarketing.portlets.links.factories.LinkFactory.getLinkFromInode(request.getAttribute("inode").toString(),user.getUserId());
		com.dotmarketing.beans.Identifier identifier = com.dotmarketing.factories.IdentifierFactory.getParentIdentifier(link);
%>
		<script>
...
<%
	...
	if (request.getAttribute(com.dotmarketing.util.WebKeys.LINK_EDIT)!=null) {
		...
		contentLink = (com.dotmarketing.portlets.links.model.Link) com.dotmarketing.portlets.links.factories.LinkFactory.getLinkFromInode(request.getParameter("inode"),user.getUserId());
	}
	...
	com.dotmarketing.beans.Identifier identifier = com.dotmarketing.factories.IdentifierFactory.getParentIdentifier(contentLink);
	...
	com.dotmarketing.portlets.folders.model.Folder folder = (com.dotmarketing.portlets.folders.model.Folder) com.dotmarketing.factories.InodeFactory.getInode(String.valueOf(contentLink.getParent()),com.dotmarketing.portlets.folders.model.Folder.class);
	...
	<div id="fileBasicTab" dojoType="dijit.layout.ContentPane" title="<%= LanguageUtil.get(pageContext, "Properties") %>" onShow="showEditButtonsRow()">
		...
		<%}%>
			...
			<dd>
				...
				<% } else { %>
					<input type="text" readonly="readonly" styleClass="form-text" value="<%= folder.getPath() %>" />
