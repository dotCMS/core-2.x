...
function submitfmEvent(form, subcmd, catCounter)
	{
	...
	dijit.byId('savingContentDialog').show();
 	...
 	saveEvent(isAutoSave, catCounter);
 	return;
}
function saveEvent(isAutoSave, catCounter){
...
<script type="text/javascript">
	...
	var isShowAllLocations = true;//DOTCMS-5173
