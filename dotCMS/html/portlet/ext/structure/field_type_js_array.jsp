...
<%@page import="com.dotmarketing.db.DbConnectionFactory"%>
	...
	var myData = {
		...
		items: [
		{
			...
			id: 'categories_tab',
			displayName: '<%= LanguageUtil.get(pageContext, "Categories-Field") %>',
			label: '<span class="tabIcon"></span> <%= LanguageUtil.get(pageContext, "Categories-Field") %>',
			imageurl: '/html/images/icons/ui-tab.png',
			show:['elementSelect','displayType','labelRow'],
			dataType:'system_field',
			helpText:'<%= UtilMethods.escapeSingleQuotes(LanguageUtil.get(pageContext, "field.type.help.categories_tab")) %>'
		},{
			id: 'checkbox',
			...
			show:['elementSelect','labelRow','valueRow','textAreaValues','displayType'],
			dataType:'text_area',
			...
			show:['elementSelect','required','labelRow','valueRow','textAreaValues','displayType','validationRow','defaultText','userSearchable','indexed','listed','unique'],
			dataType:'text_area',
			...
			show:['elementSelect','required','labelRow','displayType','dataTypeRow','radioText'],
			dataType:'text',
