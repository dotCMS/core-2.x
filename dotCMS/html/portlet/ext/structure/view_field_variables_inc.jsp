...
<script type="text/javascript">
	...
	dojo.declare("FieldVariablesAdmin", null, {
		...
		fieldId: 0,
	 	...
	 	//Methods
	 	showFieldVariables: function (fieldId) {
	 	...
	 	showFieldVariablesCallback: function (variables) {
			...
			dojo.html.set(dojo.byId('fieldVariablesTable'), '');
			this.currentIndex = 0;
			...
			if(variables.length > 0)	
				dojo.style(dojo.byId('noFieldVariables'), 'visibility', 'hidden');		
			else
				dojo.style(dojo.byId('noFieldVariables'), 'visibility', 'visible');		
		...
		insertVariable: function (variable) {
			...
			dojo.place( buffer, dojo.byId('fieldVariablesTable'), "last");
			this.currentIndex++;
		},
		...
		deleteVariableCallback: function () {
			this.showFieldVariables(this.fieldId);
		...
		filterResults: function () {
			...
			for(i = 0; i < this.currentIndex; i++) {
				...
				if(found == 0 && filterCriteria != '') {
					dojo.byId('noFieldVariables').show();
				} else if(found > 0) {
					dojo.byId('noFieldVariables').hide();
				}
			}
    ...
    dojo.addOnLoad(dojo.hitch(this, function(){
        ...
        fieldVariablesAdmin.showFieldVariables(fieldVariablesAdmin.fieldId);
    }))
...
<div id="viewFieldVariablesDialog">
    <table class="listingTable">
		...
		<tbody id="fieldVariablesTable">
		
		</tbody>
		<tbody id="noFieldVariables" style="visibility:hidden;">
			<tr>
...
<div id="editFieldVariable"  dojoType="dijit.Dialog" style="display: none; width: 400px;">
	...
	<!--
		...
		<dd><input dojoType="dijit.form.TextBox" type="text" maxlength="255" id="fieldVariableKey"></dd>
