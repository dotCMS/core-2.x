	...
	<table class="listingTable" >
		<tr>
			...
			<th width="10%">
				...
				<%= LanguageUtil.get(pageContext, "Type") %></a>
		...
		for (int i = 0; i < structures.size(); i++) {
			...
			String strTypeName =  LanguageUtil.get(pageContext, "Content");
			 if(structure.getStructureType() == STRUCTURE_TYPE_WIDGET){
				 strTypeName = LanguageUtil.get(pageContext, "Widget");
			 }else if(structure.getStructureType()  == STRUCTURE_TYPE_FORM){
				 strTypeName = LanguageUtil.get(pageContext, "Form");
			 }
