...
<div id="TabOne" dojoType="dijit.layout.ContentPane" title="Overview">
	...
	<dl id="hintText" style="display:none">
		...
		<dd><input type="text" dojoType="dijit.form.TextBox" name="hint" trim="true" maxlength="255" style="width:250px" value="<%= UtilMethods.isSet(fieldForm.getHint()) ? UtilMethods.escapeDoubleQuotes(fieldForm.getHint()) : "" %>" /></dd>
	</dl>
	<!-- END Field Options -->
...
<%if(hasInode){ %>
	<!-- START Tab2 -->
	<div id="TabTwo" dojoType="dijit.layout.ContentPane" title="Field Variables">
