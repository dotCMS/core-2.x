...
// 			class : "blank",
	...
	function addCatFromField<%=counter%>(inode, name) {
...
<div id="categoriesDialog<%=counter%>" dojoType="dijit.Dialog" style="display:none;width:630px;height:440px;vertical-align: middle; " draggable="true"
	title="<%= LanguageUtil.get(pageContext, "categories") %>" >
		...
		<div style="margin-top: 10px">
				<input name="catFilter" id="catFilter<%=counter%>" onblur="alterFocus<%=counter%>(document.activeElement, this);" onkeyup="doSearch<%=counter%>();"  dojoType="dijit.form.TextBox" placeholder="<%= LanguageUtil.get(pageContext, "message.filter.categories") %>" style="width: 138px; height: 15px" />
