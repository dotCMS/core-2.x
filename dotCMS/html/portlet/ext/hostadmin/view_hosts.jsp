...
<div id="addHostDialog" dojoType="dijit.Dialog">
    <form id="addHostDialogForm" dojoType="dijit.form.Form">
        ...
        <div id="addHostStep1">
            ...
            <hr/>
            <div class="buttonRow">
                <button dojoType="dijit.form.Button" onClick="hostAdmin.goToStep2(); dojo.stopEvent(event);" iconClass="nextIcon">
                    <%= LanguageUtil.get(pageContext, "Next") %>
                </button>
                <button dojoType="dijit.form.Button" onClick="hostAdmin.cancelCreateHost(); dojo.stopEvent(event);" iconClass="cancelIcon">
        ...
        <div id="addHostStep2" style="display: none">
		 ...
		 <div style="float: right">
            ...
            <div class="buttonRow" style="clear: both;">
                <hr/>
                <button dojoType="dijit.form.Button" onClick="hostAdmin.goToStep1(); dojo.stopEvent(event);" iconClass="previousIcon">
                    <%= LanguageUtil.get(pageContext, "Previous") %>
                </button>
                <button dojoType="dijit.form.Button" onClick="hostAdmin.gotoCreateHost(); dojo.stopEvent(event);" iconClass="nextIcon">
                    <%= LanguageUtil.get(pageContext, "Next") %>
                </button>
                <button dojoType="dijit.form.Button" onClick="hostAdmin.cancelCreateHost(); dojo.stopEvent(event);" iconClass="cancelIcon">
                    <%= LanguageUtil.get(pageContext, "Cancel") %>
