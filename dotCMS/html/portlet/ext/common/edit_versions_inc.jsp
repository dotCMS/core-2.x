...
<%
	...
	if (isContentlet) {
		Identifier ident = IdentifierCache.getIdentifierFromIdentifierCache(cver);
		...
		Identifier iden = IdentifierFactory.getIdentifierByInode(v);
		WebAsset working = (WebAsset) IdentifierFactory.getWorkingChildOfClass(iden, v.getClass());
