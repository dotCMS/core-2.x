...
<%@page import="com.dotmarketing.portlets.folders.factories.FolderFactory.InternalCounter"%>
			...
			<td align="center">
				<table><tr><td>
					<% 
						...
						int level = 0;
						FolderFactory.InternalCounter counter = new FolderFactory().new InternalCounter();
