...
<html style="padding:0;margin:0;overflow:hidden;height:620px;width:920px;">
<head>
	...
	<script>
		...
		function openAddress(){
			dojo.byId("viewingUrl").value
			newwin = window.open(dojo.byId("viewingUrl").value, "newwin", "width=700,height=500,scrollbars=1,addressbar=1,resizable=1,menubar=1,toolbar=1");
			newwin.focus();
		}
...
<body class="dmundra" style="padding:0;margin:0;height:620px;width:920px;">
	...
	<div id="main" >
		<div class="imageToolButtonBar dijitLayoutContainer">
			...
			<input type="text" id="viewingUrl" dojoType="dijit.form.TextBox" value="<%=baseImage %>" onfocus="imageEditor.selectAllUrl()">
			...
			<table id="controlTable" align="center">
				<tr>
					<td rowspan="3" id="zoomTd">
						<div style="text-align:left;padding-left:30px;">resize: <span id="zoomInfo"></span></div>
		...
		<div class="imageToolButtonBar dijitLayoutContainer" style="text-align:right;border-top:0;">
