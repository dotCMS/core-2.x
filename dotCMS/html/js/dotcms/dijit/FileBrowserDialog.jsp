...
<div id="${id}" style="display: none;">
		...
		<form dojoAttachPoint="search_form" onsubmit="return false;">
		    <div dojotype="dijit.layout.BorderContainer" design="sidebar" gutters="false" livesplitters="true" style="${style}" class="shadowBox headerBox">
		        ...
		        <div dojotype="dijit.layout.ContentPane" splitter="true" region="center" title="Files" dojoAttachPoint="tablesContentPane">
					<div class="filterBox">
						<div class="viewSelectorBox" style="float: right;padding:0;">
						...
						<div style="float: left;">
							...
							<input dojoType="dijit.form.TextBox" dojoAttachEvent="onKeyDown: _filter" trim="true" dojoAttachPoint="filterTextBox" style="padding:1px 5px;">
	...
	<div dojoAttachPoint="addFileDialog" dojoType="dijit.Dialog" title="<%= LanguageUtil.get(pageContext, "Upload-a-file")%>">
		<div dojoAttachPoint="addFileIFrameWrapper" style="width: 700px; height: 280px;">
			<iframe dojoAttachEvent="onload: _addFileIFrameLoaded" scrolling="no" style="border: 0; width: 700px; height: 280px; overflow: hidden;" dojoAttachPoint="addAFileIFrame"></iframe>
		</div>
	</div>	
