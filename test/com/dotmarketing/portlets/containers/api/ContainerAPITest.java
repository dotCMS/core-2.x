...
public class ContainerAPITest extends ServletTestCase {
	...
	public void testCopy() throws Exception {
		...
		try {
			...
			Structure structure = (Structure) InodeFactory.getParentOfClass(testContainerCopy, Structure.class);
	...
	public void testCopyToAnotherHosts() throws Exception {
		...
		try {
			...
			Structure structure = (Structure) InodeFactory.getParentOfClass(testContainerCopy1, Structure.class);
			...
			List<Container> allVersions = identifierAPI.findVersionsandLiveandWorkingChildrenOfClass(identifier, Container.class);
			...
			structure = (Structure) InodeFactory.getParentOfClass(testContainerCopy2, Structure.class);
			...
			allVersions = identifierAPI.findVersionsandLiveandWorkingChildrenOfClass(identifier, Container.class);
			assertTrue("Invalid number of version in second copy container: " + allVersions.size(), (allVersions.size() == 1));
			
			identifier = identifierAPI.findFromInode(testHost2.getIdentifier());
			List<Container> containers = InodeFactory.getChildrenClassByCondition(identifier, Container.class, "working=" + DbConnectionFactory.getDBTrue());
	...
	public void testGetContainersInTemplate() {
