...
public class TemplateAPITest extends ServletTestCase {
	...
	public void testCopyOverwriteReuseContainers() throws Exception {
		...
		try {
			...
			List<Template> allVersions = identifierAPI.findVersionsandLiveandWorkingChildrenOfClass(identifier, Template.class);
			...
			List<Template> templates = InodeFactory.getChildrenClassByCondition(identifier, Template.class, "working=" + DbConnectionFactory.getDBTrue());
	...
	public void testFindTemplatesUnder() throws DotDataException {

		FolderAPI folderAPI = APILocator.getFolderAPI();
		Folder f = folderAPI.findFolderByPath("/calendar");
