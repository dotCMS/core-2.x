...
public class FixTask00050FixInodesWithoutContentlets implements FixTask {
	...
	/* Queries */
	private static final String selectInodeContentletWithoutContent = "select inode, identifier from inode where type = 'contentlet' and inode not in (select inode from contentlet)";
	...
	private static final String cleanIdentifierInodeContentletWithoutContent = "delete from identifier where inode = ?";
