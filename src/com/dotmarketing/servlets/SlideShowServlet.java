	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		try {
			...
			if (slideShowSt == null ||(!InodeUtils.isSet(slideShowSt.getInode())) ) {
				...
				entity.setEntityName(slideShowSt.getName());
				InodeFactory.saveInode(entity);
				slideShowSt.addParent(entity, WebKeys.Structure.STRUCTURE_ENTITY);
			} 
			...
			if (slideSt == null || (!InodeUtils.isSet(slideSt.getInode()))) {
				...
				Entity entity = new Entity();
				entity.setEntityName(slideSt.getName());
				InodeFactory.saveInode(entity);
				slideSt.addParent(entity, WebKeys.Structure.STRUCTURE_ENTITY);
...
//					slideShowTitleF.getFieldContentlet() + " = '" + UtilMethods.sqlify(title) + "'");
			...
			for (Contentlet slide : slideImages) {
				...
				File slideImage = (File) FileFactory.getFileByIdentifier(slideImageIdentifier, true);
