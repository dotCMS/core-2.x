...
//        com.dotmarketing.util.Config.setMyApp(config.getServletContext());
        ...
        //Checking and initializing lucene indexes
        LuceneUtils.checkAndInitialiazeIndex();   
...
//        }
        ...
        if (!Config.getBooleanProperty("LAZY_ASSET_MAPPING", true)) {
            // maps all live pages and file uri's into a hashmap
            PublishFactory.publishAllLiveAssets();

            // maps all working pages and file uri's into a hashmap
            PreviewFactory.mapAllWorkingAssets();

            // maps all permission for live pages into a hashmap
