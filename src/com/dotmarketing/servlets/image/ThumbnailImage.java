        ...
        if( InodeUtils.isSet(identifier) ) {
        	...
        	try {
	        	...
	        	if(ident != null && (InodeUtils.isSet(ident.getInode())) ) {
	                ...
	                if(file !=null && ident == null){
	                	ident = new Identifier();
	                	ident.setInode(file.getIdentifier());
	                }
	        	}
        ...
        try {
            ...
            if( inode != null && inode.length() > 0 && InodeUtils.isSet(inode) )
            {
                ...
                if (InodeUtils.isSet(file.getInode())) {
                    ...
                    String thumbnailFilePath = filePath + java.io.File.separator + workingFileInodePath + java.io.File.separator 
                    ...
                    synchronized (inode.intern()) {
	                    ...
	                    if (!thumbFile.exists() || (request.getParameter("nocache") != null)) {
	                        com.dotmarketing.util.ImageResizeUtils.generateThumbnail(
	                                filePath + java.io.File.separator + workingFileInodePath + java.io.File.separator, inode, suffix,
	                                generatedKey, width, height, bgColor);
            ...
            Logger.error(ThumbnailImage.class, "Error creating thumbnail from servlet: " + e.getMessage());
        }
