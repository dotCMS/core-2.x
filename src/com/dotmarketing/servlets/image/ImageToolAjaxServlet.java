...
public class ImageToolAjaxServlet extends HttpServlet {
    ...
    private void doSaveAs(HttpServletRequest request, HttpServletResponse response, String inode, String fileName){
		...
		try {
			...
			copiedFile.setMimeType(FileFactory.getMimeType(fileName));
			...
			Folder folder = APILocator.getFileAPI().getFileFolder(src);
			//System.out.println("source:" + src.getPath());
			//System.out.println("folder:" + folder.getPath());
			//System.out.println("fileId:" + fileId.getURI());

			String x = WorkingCache.getPathFromCache(folder.getPath() + fileName, h);
