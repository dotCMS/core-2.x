		...
		try {
			...
			for (HashMap map : l) {
				...
				try {
					...
					Identifier ident = IdentifierCache.getIdentifierFromIdentifierCache(iden);
					// http://jira.dotmarketing.net/browse/DOTCMS-1418
					...
					if(avgField != null && c != null){
						ctAvgObj = (Float) conAPI.getFieldValue(c, s.getField("Average Rating"));
					}
