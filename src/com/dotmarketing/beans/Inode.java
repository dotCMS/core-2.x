 ...
 */
public class Inode implements Serializable, Comparable, Permissionable,
		Categorizable, Versionable, UUIDable {
	...
	public void setInode(String inode) {
		...
		}else if(!inode.equals(Host.SYSTEM_HOST)){
			try {
	...
	public String getInode() {
		if (inode != null) {
			if (inode.contains("-")) {
				...
				if(inode.equals(Host.SYSTEM_HOST)){
					return inode;
				}
				try {
