...
import com.dotcms.enterprise.cmis.File;
...
public class InodeUtils {
     ...
     *
     * @param   inodeStr   Inode.inode which is a String.
     *  
     * @return  the value <code>True</code> if the inodeStr is a in valid UUID.toString() format or inodeStr is a positive long.
     * 			else the value <code>False</code>. 			
     * 
     */	
     ...
     *
     * @param   inodeStr1   Inode.inode which is a String.
     * @param   inodeStr2   Inode.inode which is a String.
     * 
     * @return  the value <code>0</code> if the Inode corresponding to inodeStr1 is created at the same time as Inode corresponding to inodeStr2. 
     *          a value less than <code>0</code> if the Inode corresponding to inodeStr1 is created before the Inode corresponding to inodeStr2.
     *          and a value greater than <code>0</code> if the Inode corresponding to inodeStr1 is created after the Inode corresponding to inodeStr2. 
     * 
     */
	...
	public static Class getClassByDBType(String type){
		...
		else if(type.equals("ecom_product")){
		...
		else if(type.equals("ecom_product_format")){
		...
		else if(type.equals("ecom_product_price")){
		...
		else if(type.equals("event_recurance")){
			return Recurance.class;
		}		
