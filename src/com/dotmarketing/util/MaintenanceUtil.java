...
public class MaintenanceUtil {
	...
	private static boolean fileAssetSearchAndReplace(String textToSearchFor, String textToReplaceWith,String mimeTypesOfFile){
		...
		for (Map<String,Object> result : results) {
			...
			try{
				f = new File(FileFactory.getRealAssetPath(result.get("inode").toString(), UtilMethods.getFileExtension(result.get("file_name").toString())));
			}catch (Exception e) {
				hasErrors = true;
	...
	public static List<Object> findFileAssetsCanBeParsed() {
        ...
        File folder = new File(FileFactory.getRealAssetPath());
