...
public class HibernateUtil {
	...
	public static void delete(Object obj) throws DotHibernateException {
		try{
			...
			throw new DotHibernateException("Error deleteing object ", e);
		}
	}
	...
	public List list() throws DotHibernateException{
		try{
			...
			throw new DotHibernateException("Unable to get list from Hibernate Query object ", e);
		}
	}
	...
	public Object load() throws DotHibernateException{
		try{
			...
			throw new DotHibernateException("Unable to load Object from Hibernate Session ", e);
		}
	}
