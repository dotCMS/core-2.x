...
public class CrawlerUtil {
	...
	private void indexHost(final Host host) throws Exception {
		...
		synchronized(host){
			...
			File searchIndexFolder = new File(FileFactory.getRealAssetPath()+Path.SEPARATOR+SEARCH_INDEX_DIR);
