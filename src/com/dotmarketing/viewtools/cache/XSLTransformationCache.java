	...
	public static XSLTranformationDoc getXSLTranformationDocByXMLPath(String XMLPath,String XSLPath) {
		...
		if (doc != null) {
			try{
				...
				Identifier xslIdentifier = IdentifierCache.getIdentifierFromIdentifierCache(doc.getIdentifier());
				File xslFile = FileFactory.getFileByIdentifier(xslIdentifier, true);
