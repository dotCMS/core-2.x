...
public class File extends WebAsset implements Serializable {
	...
	public String getURI(Folder folder) {
		return folder.getPath() + this.getFileName();
	}
	public String getURI() {
		Identifier id = IdentifierFactory.getIdentifierByInode(this);
		return id.getURI();
	...
	public String getPath() 
	{
		...
		if(myPath == null){
			...
			try
			{
				Folder folder = (Folder) InodeFactory.getParentOfClass(this,Folder.class);
	...
	public Permissionable getParentPermissionable() throws DotDataException {
		...
		try {
			Folder parentFolder = (Folder) InodeFactory.getParentOfClass(this, Folder.class);
