...
public interface ContentletAPI {
	 ...
	 * @throws DotDataException
	 */
	public void cleanHostField(Structure structure, User user, boolean respectFrontendRoles) throws DotSecurityException, DotDataException;
    ...
    */
	...
	/**
	 * Will remove a contentlet from teh lucene index
