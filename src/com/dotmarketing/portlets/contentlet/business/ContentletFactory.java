...
public abstract class ContentletFactory {
	 ...
	 * @throws DotDataException
	 */
	protected abstract Contentlet find(String inode) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract Contentlet findContentletForLanguage(long languageId, Identifier contentletId) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract Contentlet findContentletByIdentifier(String identifier, Boolean live, Long languageId) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> findContentletsByIdentifier(String identifier, Boolean live, Long languageId) throws DotDataException;
	 ...
	 * @return
	 */
	protected abstract List<Contentlet> findContentlets(List<String> inodes) throws DotDataException;
	 ...
	 */
	protected abstract List<Contentlet> findByStructure(String structureInode, int limit, int offset) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract Contentlet save(Contentlet contentlet) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> search(String luceneQuery, int limit, int offset, String sortBy) throws ParseException, DotDataException;
	 ...
	 * @throws ParseException
	 */
	protected abstract LuceneHits indexSearch(String luceneQuery, int limit, int offset, String sortBy) throws ParseException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> findPageContentlets(String HTMLPageIdentifier,String containerIdentifier, String orderby, boolean working, long languageId)	throws  DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> getContentletsByIdentifier(String identifier, Boolean live) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> getContentletsByIdentifier(String identifier) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> findAllUserVersions(Identifier identifier) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract List<Contentlet> findAllVersions(Identifier identifier) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract Contentlet convertFatContentletToContentlet (com.dotmarketing.portlets.contentlet.business.Contentlet fatty) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract com.dotmarketing.portlets.contentlet.business.Contentlet convertContentletToFatContentlet (Contentlet cont, com.dotmarketing.portlets.contentlet.business.Contentlet fatty) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void cleanField(String structureInode, Field field) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void cleanHostField(String inode) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void cleanIdentifierHostField(String structureInode) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void lock(String contentletInode, User user) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void unlock(String contentletInode, User user) throws DotDataException;
	...
	protected abstract void UpdateContentWithSystemHost(String hostIdentifier) throws DotDataException;
	/**
	 * Method will remove User References of the given userId in Contentlet
	 * @param userId
	 */
	protected abstract void removeUserReferences(String userId)throws DotDataException;

	protected abstract void deleteVersion(Contentlet contentlet)throws DotDataException;

	protected abstract void unpublishAllVersions(Contentlet contentlet, User user)throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void removeFolderReferences(Folder folder) throws DotDataException;


	protected abstract List<HashMap<String, String>> getFieldValues(String fieldContentlet, String structureInode) throws DotDataException;
