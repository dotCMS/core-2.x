...
public class Structure extends Inode implements Permissionable
{
	...
	{
		Entity entity = (Entity) InodeFactory.getParentOfClassByRelationType(this,Entity.class,WebKeys.Structure.STRUCTURE_ENTITY);

		//create one if we have nothing.
		if(!InodeUtils.isSet(entity.getInode())){
			entity.setEntityName(this.getName());
			InodeFactory.saveInode(entity);
			Tree tree = new Tree();
			tree.setParent(entity.getInode());
			tree.setChild(this.getInode());
			tree.setRelationType(WebKeys.Structure.STRUCTURE_ENTITY);
	...
	public Permissionable getParentPermissionable() throws DotDataException {
		try {
			...
			if(UtilMethods.isSet(getFolder()) && !getFolder().equals("SYSTEM_FOLDER")){
				...
				return APILocator.getFolderAPI().find(getFolder());
