...
public class StructureFactory {
	...
	{
		Structure structure = null;
		String condition = " velocity_var_name = '" + varName + "'";
	...
	public static void saveStructure(Structure structure)
	{
		...
		InodeFactory.saveInode(structure);
	}

	//### DELETE ###
	public static void deleteStructure(String inode)
	{
