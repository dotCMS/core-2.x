...
public class MailingListFactory {
	 ...
	 */
	public static boolean addMailingSubscriber (MailingList ml, UserProxy up, boolean force) {
	 ...
	 */
	public static boolean unsubcribeFromMailingList (MailingList ml, UserProxy up, boolean force) {
	 ...
	 */
	public static boolean markAsBounceFromMailingList (MailingList ml, UserProxy up) {
		Tree currentRel = TreeFactory.getTree(ml, up, null);
		if (currentRel != null && InodeUtils.isSet(currentRel.getChild())) {
			TreeFactory.deleteTree(currentRel);
