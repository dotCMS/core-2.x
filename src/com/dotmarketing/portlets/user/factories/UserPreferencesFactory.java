...
public class UserPreferencesFactory {
	...
	public static UserPreference getUserPreference(String x) {
        try {
            return ( UserPreference ) new DotHibernate(UserPreference.class).load(Long.parseLong(x));
        } catch (Exception e) {
            return ( UserPreference ) new DotHibernate(UserPreference.class).load(x);
        }
    }
    ...
    public static java.util.List getUserPreferences(String userId) {
        try {
            ...
            DotHibernate dh = new DotHibernate(UserPreference.class);
