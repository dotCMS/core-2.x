...
public class UserCommentsFactory {
    ...
    public static void deleteUserComment(String userProxyInode,UserComment userComment) 
    {
    	UserProxy userProxy;
		try {
    ...
    public static void deleteUserComment(String userProxyInode,String userCommentInode) 
    {    	
    	UserComment userComment = UserCommentsFactory.getComment(userCommentInode);
    	deleteUserComment(userProxyInode,userComment);    	    	    	
    }

    public static void saveUserComment(String userProxyInode,UserComment userComment) 
    {
    	UserProxy userProxy;
		try {
			userProxy = com.dotmarketing.business.APILocator.getUserProxyAPI().getUserProxy(userProxyInode,APILocator.getUserAPI().getSystemUser(), false);
    	...
    	InodeFactory.saveInode(userComment);
    	userProxy.addChild(userComment);
    }
    
    public static void saveUserComment(UserComment userComment) 
    {
	...
	public static java.util.List getUserCommentsByUserId(String userId, int offset, int limit) {
        try {
            DotHibernate dh = new DotHibernate(UserComment.class);
