...
public class Folder extends Inode implements Serializable, Permissionable {
	...
	public String getInode() {
		if(InodeUtils.isSet(inode))
			return inode;
		else if(UtilMethods.isSet(inode)&& inode.equalsIgnoreCase(FolderFactory.SYSTEM_FOLDER))// DOTCMS-3232
			return FolderFactory.SYSTEM_FOLDER;
		return "";
	}
	...
	public Permissionable getParentPermissionable() throws DotDataException {
		...
		Folder parentFolder = folderAPI.findParentFolder(this);
