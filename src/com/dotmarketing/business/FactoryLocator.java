...
import com.dotmarketing.common.business.journal.DistributedJournalFactoryImpl;
...
public class FactoryLocator extends Locator<FactoryIndex>{
    ...
    public static ReindexContentletFactory getReindexContentletFactory(){
    	return (ReindexContentletFactory)getInstance(FactoryIndex.REINDEX_CONTENTLET_FACTORY);
    }
...
{ 
	...
	Object create() {
		switch(this) {
            ...
            case CONTENTLET_FACTORY: return new ContentletFactoryDBImpl();
            case REINDEX_CONTENTLET_FACTORY: return new ReindexContentletFactoryImpl();
            ...
            case DISTRIBUTED_JOURNAL_FACTORY: return new DistributedJournalFactoryImpl<String>("0");
