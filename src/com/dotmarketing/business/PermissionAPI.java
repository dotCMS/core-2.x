...
public interface PermissionAPI {
	...
	int PERMISSION_USE = com.dotmarketing.util.Config.getIntProperty("PERMISSION_USE");
	int PERMISSION_EDIT = com.dotmarketing.util.Config.getIntProperty("PERMISSION_EDIT");

	// Default Permission keys from assets
	int PERMISSION_READ = com.dotmarketing.util.Config.getIntProperty("PERMISSION_READ");
	int PERMISSION_WRITE = com.dotmarketing.util.Config.getIntProperty("PERMISSION_WRITE");
	int PERMISSION_PUBLISH = com.dotmarketing.util.Config.getIntProperty("PERMISSION_PUBLISH");
	int PERMISSION_EDIT_PERMISSIONS = com.dotmarketing.util.Config.getIntProperty("PERMISSION_EDIT_PERMISSIONS");
	int PERMISSION_CREATE_VIRTUAL_LINKS = com.dotmarketing.util.Config.getIntProperty("PERMISSION_CREATE_VIRTUAL_LINKS");
	int PERMISSION_CAN_ADD_CHILDREN = com.dotmarketing.util.Config.getIntProperty("PERMISSION_CAN_ADD_CHILDREN");
