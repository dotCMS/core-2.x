...
public class DotPortletAction extends PortletAction {
	...
	throws Exception {
		...
		Folder parent = (Folder) InodeFactory.getParentOfClass(webAsset, Folder.class);
	...
	public void _moveWebAsset(ActionRequest req, ActionResponse res, PortletConfig config, ActionForm form, User user, Class webAssetClass,
		...
		WebAsset webAsset = (WebAsset) req.getAttribute(webKey);
		Identifier identifier = com.dotmarketing.factories.IdentifierFactory.getParentIdentifier(webAsset);
	...
	public void _retrieveWebAsset(ActionRequest req, ActionResponse res, PortletConfig config, ActionForm form, User user, Class myClass,
		...
		WebAsset webAsset = (WebAsset) InodeFactory.getInode(req.getParameter("inode"), myClass);
	...
	throws Exception {
		...
		if (!(WebAssetFactory.isAbstractAsset(webAsset))) {
			if (InodeUtils.isSet(webAsset.getInode())) {
				parentFolder = (Folder) com.dotmarketing.factories.InodeFactory.getParentOfClass(webAsset, Folder.class);
			} else {
				parentFolder = (Folder) com.dotmarketing.factories.InodeFactory.getInode(req.getParameter("parent"), Folder.class);
			}
		}
