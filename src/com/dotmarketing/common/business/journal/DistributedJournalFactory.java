...
public abstract class DistributedJournalFactory<T> {
	...
	public static final int REINDEX_ACTION_REINDEX_FULL = 3;
	...
	/**
	 * Will add a reindex entry for the content for all servers other then himself
	 * @param contentlet object (Only inode and identifier need to be set)
	 * @throws DotDataException
	 */
	protected abstract void addContentIndexEntry(Contentlet c) throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract boolean buildNewIndexForServer() throws DotDataException;
	 ...
	 * @throws DotDataException
	 */
	protected abstract void addContentIndexEntryToDelete(T contentIdentifier) throws DotDataException;
