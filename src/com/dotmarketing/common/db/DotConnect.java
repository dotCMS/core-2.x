...
public class DotConnect {
     ...
     * @return ArrayList
     */
    public ArrayList getResults(String dataSource) {
        if (gotResult == false) {
     ...
     * @return ArrayList
     */
    public List<Map<String, Object>> getObjectResults() {
        if (gotResult == false) {
            getResult();
        }
        return (objectResults != null) ? objectResults : new ArrayList <Map<String, Object>>();
     ...
     * @return ArrayList
     */
    public List<Map<String, Object>> getObjectResults(String dataSource) {
        if (gotResult == false) {
            getResult(dataSource);
        }
        return (objectResults != null) ? objectResults : new ArrayList <Map<String, Object>>();
