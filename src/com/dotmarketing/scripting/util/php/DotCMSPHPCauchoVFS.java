...
public class DotCMSPHPCauchoVFS extends FilesystemPath {
	...
	public boolean exists()
	{
		...
		_folder = FolderFactory.getFolderByPath(getPath(), host);
...
//		}
		String uri;
		Identifier ident = IdentifierCache.getPathFromIdCache(getPath(), host);
		try{
		...
		try{
			...
			mu = APILocator.getUserAPI().loadUserById(file.getModUser(), APILocator.getUserAPI().getSystemUser(), true);
		}catch (Exception e) {
