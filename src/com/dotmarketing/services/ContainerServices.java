...
public class ContainerServices {
    ...
    public static void invalidate(Container container, boolean EDIT_MODE) {
    ...
    public static InputStream buildVelocity(Container container, Identifier identifier, boolean EDIT_MODE) {
        ...
        Structure st = (Structure) InodeFactory.getParentOfClass(container, Structure.class);
        ...
        if (container.getMaxContentlets() > 0) {
            ...
            if (isDynamic) {
                Structure containerStructure = (Structure) InodeFactory.getParentOfClass(
                        container, Structure.class);
    ...
    public static void unpublishContainerFile(Container container) {

        Identifier identifier = IdentifierFactory.getParentIdentifier(container);
        removeContainerFile(container, identifier, false);
    }
    
    public static void removeContainerFile(Container container, boolean EDIT_MODE) {
