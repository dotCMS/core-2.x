...
public class ContentletServices {
	...
	public static void invalidate(Contentlet contentlet) throws DotDataException, DotSecurityException {
		...
		Identifier identifier = IdentifierCache.getIdentifierFromIdentifierCache(contentlet);
	...
	public static InputStream buildVelocity(Contentlet content, Identifier identifier, boolean EDIT_MODE) throws DotDataException, DotSecurityException {
		...
		Logger.debug(ContentletServices.class, "Build Velocity for contentlet =" + content.getInode() + " identifier=" + identifier.getInode());
...
//					sb.append("#set( $" + field.getVelocityVarName() + " = $fieldStringWriter" + content.getInode() + field.getInode()  + ".toString())\n");
			...
			if (field.getFieldType().equals(Field.FieldType.IMAGE.toString())) {
				...
				sb.append("#set( $" + field.getVelocityVarName() + "FileInode =$UtilMethods.espaceForVelocity($" + field.getVelocityVarName() + "Object.getInode() ))\n");
				sb.append("#set( $" + field.getVelocityVarName() + "FileIdentifier =$UtilMethods.espaceForVelocity($" + field.getVelocityVarName() + "Object.getIdentifier() ))\n");
				sb.append("#set( $" + field.getVelocityVarName() + "FileExtension =$UtilMethods.espaceForVelocity($" + field.getVelocityVarName() + "Object.getExtension() ))\n");
				sb.append("#set( $" + field.getVelocityVarName() + "FileURI =$UtilMethods.espaceForVelocity($filetool.getURI($" + field.getVelocityVarName() + "Object)))\n");
				sb.append("#set( $" + field.getVelocityVarName() + "FileTitle =$UtilMethods.espaceForVelocity($" + field.getVelocityVarName() + "Object.getTitle() ))\n");
...
//			}//http://jira.dotmarketing.net/browse/DOTCMS-3232
		...
		Logger.debug(ContentletServices.class, "SHOW_VELOCITYFILES=" + Config.getBooleanProperty("SHOW_VELOCITYFILES", false));
		
		if(Config.getBooleanProperty("SHOW_VELOCITYFILES", false)){
			try {

				String velocityRootPath = Config.getStringProperty("VELOCITY_ROOT");
				Logger.debug(ContentletServices.class, "velocityRootPath=" + velocityRootPath);
				...
				Logger.debug(ContentletServices.class, "filePath=" + filePath);
	...
	public static void unpublishContentletFile(Contentlet asset) {
		...
		try {
			identifier = IdentifierCache.getIdentifierFromIdentifierCache(asset);
	...
	public static void removeContentletFile(Contentlet asset, boolean EDIT_MODE) {
		try {
	 ...
	 * @param contentlets
	 */
	public static void removeContentletFile(Contentlet contentlet){
	 ...
	 * @param contentlets
	 */
	public static void removeContentletFile(List<Contentlet> contentlets){
		for (Contentlet contentlet : contentlets) {
			removeContentletFile(contentlet);
		}
	}
	...
	private static void saveToDisk(String folderPath, String filePath, String data) throws IOException {
		...
		Logger.debug(ContentletServices.class, "Saving to disk folderPath =" + folderPath + " filePath=" + filePath);
