...
public class TemplateServices {
    ...
    public static void invalidate(Template template) {
    	...
    	Identifier identifier = IdentifierFactory.getParentIdentifier(template);
    	invalidate(template, identifier, false);

    }

    public static void invalidate(Template template, boolean EDIT_MODE) {
    ...
    public static InputStream buildVelocity(Template template, boolean EDIT_MODE) {
    	Identifier identifier = IdentifierFactory.getParentIdentifier(template);
    ...
    public static void unpublishTemplateFile(Template asset) {
        ...
        Identifier identifier = IdentifierFactory.getParentIdentifier(asset);
        removeTemplateFile(asset, identifier, false);
        removeTemplateFile(asset, identifier, true);
    }
    
    public static void removeTemplateFile(Template asset, boolean EDIT_MODE) {
